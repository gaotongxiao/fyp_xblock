...
(function($) {
    ...
    $.xmpp ={
        ...
        * }
        */
        register: function(jid){
            id_host = jid.split("@");
            this.sendCommand("register " + id_host[0] + " " + id_host[1] + " " + id_host[0]);
        },
        ...
        */
        ...
        sendGroupMessage: function(to, data, callback){
            // var toJid = options.to;
            // var toJid = "room1@localhost";
            //Add all parameters to the message
            var msg = "<message type='groupchat'  to='"+to+"'><body>"+data+"</body></message>";
            /*
            messageObj.find("message").attr(options);
